...
<div id="MainCenter" align="center" class="MainCenter">
		 ...
		 <div id="content" class="Sub">
				<div class="NewContainer370">
					<div class="BoxHeader">
						<div class="BoxHeader-center MarginTop10">手机信息</div>
					</div>
					<div class="Slot" style="height: 550px;">
						...
						<table width="100%" border="0">
						    ...
						    <tr>
						       <td align="center">手机名称：${requestScope.goods0.goodsName }<hr/></td>
						    </tr>
						    <tr>
						       <td align="center">手机介绍:<c:out value="${requestScope.goods0.goodsMiaoshu }" escapeXml="false"/><hr/></td>
						    </tr>
						    <tr>
				...
				<div class="NewContainer370">
					...
					<div class="Slot" style="height: 550px;">
						...
						<table width="100%" border="0">
						    ...
						    <tr>
						       <td align="center">手机名称：${requestScope.goods1.goodsName }<hr/></td>
						    </tr>
						    <tr>
						       <td align="center">手机介绍:<c:out value="${requestScope.goods1.goodsMiaoshu }" escapeXml="false"/><hr/></td>
						    </tr>
						    <tr>
